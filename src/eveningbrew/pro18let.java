...
public class pro18let extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton2.setBounds(460, 240, 210, 120);
        ...
        jButton8.setText("Есть ли вам 18 лет?");
        ...
        jButton8.setBounds(180, 100, 490, 110);
   ...
   startWorkFrame.openframe();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pro18let.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
